// Mock NextResponse from next/server to avoid global Request issues
...
describe('register API route', () => {
  ...
  test('creates user and returns ok on success', async () => {
    ...
    expect(prisma.user.create).toHaveBeenCalledWith({ data: { email: 'new@test.com', passwordHash: 'hashed-pw' } });
